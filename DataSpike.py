...
num4 > num6 and num4 > num7 and num4 > num8:
        print(num4)
    elif num5 > num1 and num5 > num2 and num5 > num3 and num5 > num4 and \
num5 > num6 and num5 > num7 and num5 > num8:
        print(num5)
    elif num6 > num1 and num6 > num2 and num6 > num3 and num6 > num4 and \
num6 > num5 and num6 > num7 and num6 > num8:
        print(num6)
    elif num7 > num1 and num7 > num2 and num7 > num3 and num7 > num4 and \
num7 > num5 and num7 > num6 and num7 > num8:
        print(num7)
    elif num8 > num1 and num8 > num2 and num8 > num3 and num8 > num4 and \
num8 > num5 and num8 > num6 and num8 > num7:
        print(num8)
main()
